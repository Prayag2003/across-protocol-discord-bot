...
if __name__ == "__main__":
    knowledge_base = load_knowledge_base("scraper/user_docs/scraped_data_user_docs.json")
    processed_data = process_knowledge_base(knowledge_base)
    save_processed_data(processed_data, "knowledge_base/embeddings/user_docs/knowledge_base_user_docs.json")